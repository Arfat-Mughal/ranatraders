...
@section('content')
    ...
    <form action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col-6">
                <label for="from_customer" class="form-label">From :<span class="text-danger">*</span></label>
            ...
            <div class="col-6">
                <label for="to_customer" class="form-label">To :<span class="text-danger">*</span></label>
