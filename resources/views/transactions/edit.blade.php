    ...
    <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-4">
                ...
                <input type="text" id="truck_no" name="truck_no" class="form-control" value="{{ $transaction->truck_no }}">
            </div>
            <div class="col-4">
                <label for="weight" class="form-label">Weight:</label>
                <input type="number" step="0.01" id="weight" name="weight" class="form-control" value="{{ $transaction->weight }}">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-4">
                <label for="rate" class="form-label">Rate:</label>
                <input type="number" step="0.01" id="rate" name="rate" class="form-control" value="{{ $transaction->rate }}">
            </div>
            <div class="col-4">
                <label for="gravity" class="form-label">Gravity:</label>
                <input type="number" step="0.01" id="gravity" name="gravity" class="form-control" value="{{ $transaction->gravity }}">
            </div>
            <div class="col-4">
                <label for="letter" class="form-label">Letter:</label>
                <input type="text" id="letter" name="letter" class="form-control" value="{{ $transaction->letter }}">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-4">
